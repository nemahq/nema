...
위에서 아래 순서: 초안 → 워크스페이스(위키) → 스페이스(목록).

> **2026-08-06 스코프 재정의**: 홈과 묻기 진입점을 LNB에서 뺐다. 홈은 쌓인 것을 보는 자리가 주제 목록으로 옮겨가면서 역할이 사라졌고, 묻기는 꺼내기 전체가 이번 범위 밖이 되면서 함께 빠졌다(`functional-spec/README.md` 참고). 아래 표의 두 행은 다시 열 때를 위해 남겨둔다.
