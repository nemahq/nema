...
- Propose exactly ONE topic whenever the input has any identifiable subject: reuse a verbatim match from <existing_topics> if one fits, otherwise invent a new short label. An empty <existing_topics> (cold registry) is NOT a reason to return none — invent one.
