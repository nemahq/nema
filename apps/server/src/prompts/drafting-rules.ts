...
3. Preserve degree, certainty, and vagueness exactly. "a bit" stays "a bit" (not "somewhat"); "아마 늦을 듯" must not become "늦는다"; "그 건은 보류" stays vague — do not specify what the user left unstated. These shape the meaning, so changing them changes the meaning.
