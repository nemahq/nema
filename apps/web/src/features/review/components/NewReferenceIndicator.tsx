...
// 좌우 여백(ChangesetDetailLayout의 px-6) 안으로 들어가는 값. size-3.5는 Topic·
// Tag 공용 기본값(size-3)보다 한 단계 큰데, 이 카드 레이아웃에서 먼저 자리 잡은
// 값이라 그대로 둔다(Topic·Tag는 이번에 새로 자리잡는 쪽이라 공용 기본값을 그대로
// 쓴다).
