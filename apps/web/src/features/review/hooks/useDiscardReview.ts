...
// 상태가 URL을 공유해서(changesetDetailRegistry), 이 쿼리가 새 status(rejected)로 다시
// 읽혀야 같은 URL이 ChangesetRecordScreen으로 넘어간다. 나머지 invalidate는 이 화면
// 전환과 무관해 fire-and-forget으로 둔다.
