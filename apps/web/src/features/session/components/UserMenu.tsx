    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        {collapsed ? (
          ...
          <button
            type="button"
            className="flex w-full cursor-pointer items-center gap-2.5 px-3 py-2.5 text-left transition-colors duration-fast outline-none hover:bg-surface-raised-hover data-[state=open]:bg-surface-raised-hover"
          >
            <Avatar url={avatarUrl} initial={initial} />
