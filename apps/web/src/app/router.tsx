...
function DraftsShell() {
  ...
  // 열고·바꾸고·닫는 모든 이동이 히스토리에 남는다 — 뒤로가기는 언제나 "마지막
  // 행동을 되돌린다"는 한 규칙으로 굴러가고, 초안을 훑다가 잘못 눌러도 이전 초안으로
  // 돌아올 수 있다. 상세를 URL에 올린 이유(주소로 가리킬 수 있는 자리)와도 맞다.
  // 목록으로 나가는 길은 뒤로가기 말고 닫기 버튼·단축키가 따로 있다.
